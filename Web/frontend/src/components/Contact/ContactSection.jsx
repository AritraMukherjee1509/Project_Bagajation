      ...
      <div className="container">
        <div className={s.row}>
          <div className={s.left}>
            ...
            <p className="muted">
              Tell us about your issue, preferred time, and location — we’ll reach out fast.
            </p>
          </div>
          <form className={s.form} onSubmit={(e)=>e.preventDefault()}>
            <input className="input" placeholder="Enter Name" />
            <input className="input" placeholder="Enter Email" type="email" />
            <input className="input" placeholder="Enter The Purpose" />
