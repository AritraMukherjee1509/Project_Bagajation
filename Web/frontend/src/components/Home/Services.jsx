...
const services = [
  {
    ...
    description: 'Professional AC installation with warranty and maintenance support',
  ...
  },
  {
    icon: <FiSettings />,
    title: 'AC Repair',
    description: 'Quick and reliable AC repair services for all brands and models',
      ...
      <div className="container">
        <div className={`${s.header} ${isVisible ? s.visible : ''}`}>
          ...
          <p className={s.description}>
            ...
            Quality service guaranteed with 24/7 support.
          </p>
        </div>
        ...
        <div className={`${s.grid} ${isVisible ? s.visible : ''}`}>
          {services.map((service, idx) => (
            <div 
              ...
              style={{ '--delay': `${idx * 0.1}s`, '--service-color': service.color }}
          ...
          <div className={`${s.moreCard} ${hoveredIndex === services.length ? s.hovered : ''}`}
            ...
            <a className={`btn btn-primary ${s.moreCta}`} href="tel:+918594849303">
              <FiPhone />
              Call Us Now
            </a>
          </div>
